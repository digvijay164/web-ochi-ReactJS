...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen p-20 -translate-y-[13vw] bg-zinc-200 font-[FoundersGrotesk]">
      ...
      <div className="w-1/2">
      <h1 className="text-[8vw] uppercase leading-none -mb-10 ">presentation</h1>
      <div className="details mt-20 font-[NeueMontreal]">
        <h1>S:</h1>
        <a className="block text-xl font-light" href="#">FaceBook</a>
        <a className="block text-xl font-light" href="#">Instagram</a>
        <a className="block text-xl font-light" href="#">Twiter</a>
      </div>
      </div>
    </div>
  );
